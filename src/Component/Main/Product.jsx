...
export default function Product({ product, getProduct, cartAdded }) {
    ...
    return (
        <div className="p-6 h-full flex flex-col space-y-4 border-2 border-gray-200 rounded-2xl relative">
            ...
            <div className="p-3 border border-gray-100 inline-fit rounded-full">
