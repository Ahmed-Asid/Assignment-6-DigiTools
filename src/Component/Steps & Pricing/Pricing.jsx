    ...
    return (
        <div className="w-[90%] md:w-[85%] lg:w-[75%] mx-auto py-30 space-y-10 flex flex-col items-center">
            <div className="grid md:grid-cols-3 gap-6 w-full">
                {pricing.map((price) => (
                    <div key={price.id} className={`p-6 rounded-2xl border border-gray-200 ${price.highlight ? 'bg-linear-to-r from-[#4f39f6] to-[#9514fa]' : 'bg-gray-50'} flex flex-col space-y-6`}>
                        ...
                        <button className={`mt-auto w-full py-3 rounded-full  ${price.highlight ? 'bg-white' : 'bg-linear-to-r from-[#4f39f6] to-[#9514fa]'}`}>
